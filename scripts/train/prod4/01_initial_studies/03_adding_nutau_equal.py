"""Train simplest SliceLID network with 4-targets and equal class weights"""
...
config = join_dicts(
    ...
    # Config
        ...
        'seed'            : 0,
        'steps_per_epoch' : 500,
        'target_pdg_iscc_list' : [ (12, 1), (14, 1), (16, 1) ],
        'test_size'       : 200000,
    # Args
        'outdir'          : 'prod4/01_initial_studies/03_adding_nutal_equal',
    }
)
